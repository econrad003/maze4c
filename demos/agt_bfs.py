"""
demos.agt_bfs - create a breadth-first search maze using the arc growing tree
    module (mazes.Algorithms.growing_tree2 via mazes.AGT.bfs)
Eric Conrad
Copyright ©2024 by Eric Conrad.  Licensed under GPL.v3.

DESCRIPTION

    This is breadth-first search (or BFS).  It is implemented using a first-in,
    first out (FIFO) queue.  This is the arc-based version.
...
def parse_args(argv):
    ...
    DESC = "Breadth-first search (BFS) arc-growing tree demonstration"
    EPI = ""
    default_dim = (8, 13)

"""
demos.dcm_vgt_sprim - color gradient for a "simplified Prim" vertex growing tree
Eric Conrad
...
COLS = 21
CENTER = 'c'
CARVER = (VGT, (), {"QueueClass":RandomQueue})

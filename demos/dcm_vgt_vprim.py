"""
demos.dcm_vgt_vprim - color gradient for a "vertex Prim" growing tree
Eric Conrad
...
COLS = 21
CENTER = 'c'
INIT = ((), {"action":"unstable"})
CARVER = (VGT, (), {"QueueClass":PriorityQueue, "init":INIT})

"""
demos.vgt_bfs - create a breadth-first search maze using the vertex growing tree
    module (mazes.Algorithms.growing_tree1 via mazes.VGT.bfs)
Eric Conrad
...
def parse_args(argv):
    ...
    DESC = "Breadth-first search (BFS) growing tree demonstration"
    EPI = ""
    default_dim = (8, 13)

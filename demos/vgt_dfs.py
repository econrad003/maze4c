"""
demos.vgt_dfs - create a depth-first search maze using the vertex growing tree
    module (mazes.Algorithms.growing_tree1 via mazes.VGT.dfs)
Eric Conrad
...
"""
import mazes
from mazes.VGT.dfs import dfs, init_maze
...
def parse_args(argv):
    ...
    DESC = "Depth-first search (DFS) growing tree demonstration"
    EPI = ""
    default_dim = (8, 13)

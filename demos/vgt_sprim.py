"""
demos.vgt_sprim - create a "Simplified Prim" maze using the vertex growing tree
    module (mazes.Algorithms.growing_tree1 via mazes.VGT.sprim)
Eric Conrad
...
DESCRIPTION
    ...
    first out (RIFO?) queue or "random queue".
...
"""
import mazes
from mazes.VGT.sprim import sprim, init_maze
...
def parse_args(argv):
    ...
    DESC = 'Simplified "Prim" growing tree demonstration'

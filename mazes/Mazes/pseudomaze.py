"""
mazes.Mazes.pseudomaze - base class implementation for pseudomazes
Eric Conrad
Copyright ©2025 by Eric Conrad.  Licensed under GPL.v3.

DESCRIPTION

    A pseudomaze is (usually) an undirected graph which defines passages
    between cells.  A pseudomaze admits loops.
...
def make_Pseudomaze(MazeClass:"class"):
    """create a pseudomaze class"""
    ...
    class PseudoMaze(MazeClass):
        """pseudomaze class - loops can be permitted
...
Pseudomaze = make_Pseudomaze(Maze)
Pseudomaze.__name__ = "Pseudomaze"

# end module mazes.Mazes.pseudomaze

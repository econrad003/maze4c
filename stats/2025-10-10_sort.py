...
print("The runs consisted of producing 100 perfect mazes for each of 14 different",
      ...
      "The mazes were all configured on a 36×36 Von Neumann grid",
      "(*OblongGrid(36,36)*)."),
print()
print("For fractal tessellation, four passes were made",
      "starting with a 1×1 trivial maze with each pass tiling alternately",
      "with either 3 rows and two columns or 2 rows and 3 columns.",
      " The three algorithms involved simple placement",
